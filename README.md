...
A comprehensive collection of resources for **Super Smash Flash 2** - the free Smash fighting game. Includes installation guides, configuration help, player resources, and community tools.
...
**Note:** The Player Guide is a clone of the [Google Doc](https://docs.google.com/document/d/1l5VrAaWmLozu9qnwdjz6MGA9GyurlkgNF8t72eZ4-54).
...
### For Linux Users
The easiest way to install SSF2 on Linux is using the automated script. For detailed instructions, see [scripts/LINUX_INSTALL_GUIDE.md](scripts/LINUX_INSTALL_GUIDE.md).
