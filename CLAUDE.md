...
- `scripts/Tests/` - developer tests, hidden from end users
...
- Tests live in `scripts/Tests/` - kept separate so users downloading the script don't see dev scaffolding
